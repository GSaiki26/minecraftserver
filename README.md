...
> [!NOTE] To customize these options, you must use `--build-arg` flag when building with `docker build`.
...
> [!NOTE] Use [https://fabricmc.net/use/server/](https://fabricmc.net/use/server/) to consult the proper versions.
